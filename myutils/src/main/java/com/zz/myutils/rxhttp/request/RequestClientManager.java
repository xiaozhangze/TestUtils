...
import com.zz.myutils.rxhttp.core.utils.SDCardUtils;
import com.zz.myutils.rxhttp.request.interceptor.BaseUrlRedirectInterceptor;
import com.zz.myutils.rxhttp.request.interceptor.CacheControlInterceptor;
import com.zz.myutils.rxhttp.request.interceptor.CacheControlNetworkInterceptor;
import com.zz.myutils.rxhttp.request.interceptor.PublicHeadersInterceptor;
import com.zz.myutils.rxhttp.request.interceptor.PublicQueryParameterInterceptor;
...
/**
 * 构建Retrofit实例，采用单例模式，全局共享同一个Retrofit
 *
 * @version v1.0.1
 * @auther zz
